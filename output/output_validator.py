...
def processInput(input_file, output_file):
    ...
    #input_wizard_set = set(fin.readline().split()) input file doesn't come with this!
    num_constraints = int(fin.readline().split()[0])

    output_ordering = fout.readline().split() #list of names in output, essentially lst
    ...
    """
    input file doesn't come with this
